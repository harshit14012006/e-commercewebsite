...
const AboutPage = () => {
  return (
    <div className="bg-gradient-to-b from-gray-50 to-white">
      {/* Hero Section */}
      <section className="relative bg-cover bg-center h-[60vh]" style={{ backgroundImage: 'url(https://your-image-url.com)' }}>
        <div className="absolute inset-0 bg-black opacity-50"></div>
        <div className="relative text-center text-white py-20">
          <h1 className="text-5xl font-bold mb-4">About Trendy Apparel</h1>
          <p className="max-w-2xl mx-auto text-lg">
            Discover the story, vision, and values that make Trendy Apparel the go-to place for fashionable clothing.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-8 text-center max-w-3xl mx-auto">
        ...
        <p className="text-lg text-gray-700 leading-relaxed">
          At Trendy Apparel, we believe that everyone deserves to feel confident and stylish. Our mission is to provide high-quality, affordable clothing that’s both fashionable and comfortable. We are committed to creating styles that empower individuals to express themselves boldly.
        </p>
      </section>
      ...
      <section className="py-16 bg-gray-100">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-8">
          <div className="bg-white p-6 shadow-lg rounded-lg">
            <h3 className="text-xl font-semibold mb-2 text-blue-600">Quality</h3>
            <p className="text-gray-600">We source only the finest materials to craft clothes that stand the test of time.</p>
          </div>
          <div className="bg-white p-6 shadow-lg rounded-lg">
            <h3 className="text-xl font-semibold mb-2 text-blue-600">Integrity</h3>
            <p className="text-gray-600">We believe in ethical business practices and transparency with our customers.</p>
          </div>
          <div className="bg-white p-6 shadow-lg rounded-lg">
            <h3 className="text-xl font-semibold mb-2 text-blue-600">Innovation</h3>
            <p className="text-gray-600">Our team continually pushes the boundaries of fashion to bring you the latest trends.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-8 text-center max-w-5xl mx-auto">
        ...
        <p className="text-lg text-gray-600 mb-12">Our dedicated team of fashion experts, designers, and customer service representatives work tirelessly to bring you the best shopping experience.</p>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-blue-400 text-center text-white">
        ...
        <p className="max-w-2xl mx-auto mb-8">
          Ready to upgrade your wardrobe? Check out our latest collections and see what’s new at Trendy Apparel!
        </p>
        <Link
          to="/shop"
